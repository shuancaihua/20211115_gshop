  ...
  <div class="shop-header">
    ...
    <div class="shop-header-discounts">
      <div class="discounts-left">
        <div
          class="activity activity-green"
          :class="supportClass[info.supports[0].type]"
          v-if="info.supports"
        >
          <span class="content-tag">
    ...
    <transition name="shopFade">
      <div class="shop-brief-modal" v-show="shopBriefShow">
...
export default {
  ...
  methods: {
    toggleShopShow() {
      this.shopBriefShow = !this.shopBriefShow;
    },
    toggleSupportShow() {
      this.activitySheetShow = !this.activitySheetShow;
    },
  },
};
</script>

...
export const RECEIVE_CATEGORYS = 'receive_categorys';//接收食品分类信息
...
export const CLEAR_CART = 'clear_shop_cart';//清除购物车

export const RECEIVE_SEARCH_SHOPS = 'receive_search_shops';//接收商品列表
